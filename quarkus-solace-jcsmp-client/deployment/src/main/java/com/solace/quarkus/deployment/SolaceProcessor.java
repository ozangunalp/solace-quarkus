...
class SolaceProcessor {
    private static final String FEATURE = "solace-jcsmp-client";
    ...
    void configureNativeCompilation(BuildProducer<RuntimeInitializedClassBuildItem> runtimeInitialized,
        ...
        reflectiveClasses.produce(ReflectiveClassBuildItem.builder("io.netty.channel.epoll.EpollSocketChannel").build());
    }
